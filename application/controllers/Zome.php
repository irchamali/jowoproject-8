...
class Zome extends CI_Controller {
	...
	function index(){
		...
		$data['post_header'] = $this->zome_model->get_post_header();
		$data['post_header_2'] = $this->zome_model->get_post_header_2();
